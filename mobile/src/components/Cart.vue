  ...
  <el-container>
    ...
    <el-main>
            ...
            <el-col :span="24">
              <div align="center">
                ...
                >
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      <el-image
                        ...
                        fit="scale-down"
                        :preview-src-list="[scope.row.product.image]"></el-image>
                    </template>
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number v-model="scope.row.count"
                                       style="width: 100px;"
                                       @change="(oldval,newval)=>handleChange(oldval,newval,scope.row)"
                                       :min="1"
                                       size="mini"
                      ></el-input-number>
                    </template>
                  ...
                  >
                    <template slot-scope="scope">
                      <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleRemove(scope.row.id)">
                        删除
                      </el-button>
                    </template>
                  </el-table-column>
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-row>
                <el-col :span="13">
                  <div align="right">
                    <el-button type="primary" size="mini" @click="handleSelection">删除选中</el-button>
                  </div>
                </el-col>
                <el-col :span="8">
                  <div align="right">
                    <div>已选择：<span style="color: red;font-size: 20px">{{count}}</span>件数</div>
                  </div>
                </el-col>
              </el-row>
            </el-col>
            <el-col :span="12">
              <el-row :gutter="10">
                <el-col :span="11">
                  <div align="right">总价：<span style="color: red;font-size: 18px">{{totalPrice}}</span>￥</div>
                </el-col>
                <el-col :span="13">
                  <div>
                    <el-button type="primary" size="mini" icon="el-icon-s-goods" @click="order1">去结算</el-button>
                  </div>
                </el-col>
              </el-row>
            </el-col>
      ...
      <el-card class="box-card card" style="margin-top: 10px">
        <el-row>
          <h2>最新推荐</h2>
          <el-col :span="4" v-for="(r, index) in newest" :key="index" :offset="index%5!=0 ? 1 : 0" v-if="index<5">
