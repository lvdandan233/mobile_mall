        ...
        <el-main>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" >
                ...
                <!--                左侧-->
                <div style="height: 175px;background-color: #E9EEF3;" shadow="hover">

                    <img
                      :src="yc.img" style="height:170px;padding: 1px;"
                      >

                </div>


                <el-card class="box-card" :body-style="{ padding: '0px' }" style="margin-top: 5px" shadow="hover" >
                  <div slot="header">
                    <span>消息通知</span>
                  </div>
          ...
          <!--网站公告区-->
          <el-row :gutter="2" style="border: solid 1px aquamarine; border-radius:20px;">
            <!--            <el-col :span="24">-->
            <!--              <i class="el-icon-message-solid" style="text-align: left;"></i>-->
            <!--            </el-col>-->
            <el-col :span="1">
              <img src="../assets/laba.png" style="height: 30px; margin-outside: 5px;padding-top: 1px" />
            </el-col>
            <el-col :span="22" style="font-size: 20px">
              <div style="padding-top: 9px;font-family: 宋体;font-size: 16px">{{gg.title}}</div>
            </el-col>
          </el-row>
          <el-row :gutter="10">
...
<!--          商品卡片-->
          <el-row>
              ...
              <el-col :span="4" v-for="(r, index) in newest" :key="index" :offset="index%5!=0 ? 1 : 0">
...
<!--                      <img :src="[r.image]" class="image">-->
            ...
            <el-col :span="4" style="margin-left: 50px">
              <div @click="more">
                <el-card :body-style="{ padding: '0px' }" shadow="hover"  style="cursor:pointer;margin-bottom: 15px;" >
                  <el-image
                    style="width: 258px; height: 150px;"
                    :src="'http://localhost:8181/assets/upload/more.jpg'"
                    fit="contain"></el-image>
                  <!--                      <img :src="[r.image]" class="image">-->
                  <div style="padding: 14px;">
                    <div align="center">
          ...
          <!--          热卖商品卡片-->
          <el-row>
            <el-col :span="4" v-for="(r, index) in pops" :key="index" :offset="index%5!=0 ? 1 : 0">
              <div @click="detail(r.id)">
                <el-card :body-style="{ padding: '0px' }" shadow="hover"  style="cursor:pointer;margin-bottom: 15px;" >
                  <el-image
                    style="width: 258px; height: 150px;"
