    ...
    <el-main>
      <el-card class="box-card">
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <div align="center">
              <el-image :src="src" style="height: 160px;width: 160px"
                        :preview-src-list="[
                        product.image
                        ]">
            ...
            <div align="center" style="margin-top: 10px">
              <el-row :gutter="10">
                <el-col :span="10" align="right"><span>综合评分:</span> </el-col>
                <el-col :span="14" align="left"><span><el-rate
          ...
          <el-col :span="12">
            <el-row :gutter="10">
              <el-col :span="8">
                颜色: <span class="size-border">&nbsp;&nbsp;{{product.color}}&nbsp;&nbsp;</span>
              </el-col>
              <el-col :span="8">
                内存: <span class="size-border">&nbsp;&nbsp;{{product.ram}}G&nbsp;&nbsp;</span>
              </el-col>
              <el-col :span="8">
                库存:  <span class="size-border">&nbsp;&nbsp;{{product.inventory}}&nbsp;&nbsp;</span>
              </el-col>
            </el-row>
            <el-row :gutter="10">
              <el-col :span="12">
                商品单价: <span class="size-border">&nbsp;&nbsp;{{product.price}}元&nbsp;&nbsp;</span>
              </el-col>
              <el-col :span="12">
                销售量: <span class="size-border">&nbsp;&nbsp;{{product.saleNum}}&nbsp;&nbsp;</span>
              </el-col>
            </el-row>
            <el-row :gutter="10">
              <el-col :span="16">
                描述: <span class="size-border">&nbsp;&nbsp;{{product.message}}&nbsp;&nbsp;</span>
              </el-col>
              <el-col :span="8">
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="6">
                 <span v-if="ifCol&&this.$store.state.userName!=null">
                  <el-button type="danger" @click="delCollect" icon="el-icon-star-off">取消收藏</el-button>
                </span>
                <span v-else>
                  <el-button type="success" @click="addCollect" icon="el-icon-star-off">添加收藏</el-button>
                </span>

              </el-col>
              <el-col :span="6">
                <el-button type="primary" @click="add" icon="el-icon-edit-outline">我要评论</el-button>
              </el-col>
              <el-col :span="6">
                <el-button type="primary" icon="el-icon-circle-plus-outline" @click="addCart">加入购物车</el-button>
              </el-col>
              <el-col :span="6">
                <el-button type="primary" @click="cartGo" ><i style="font-size:16px;color: gold" class="el-icon-shopping-cart-1"></i>去购物车</el-button>
              </el-col>
            </el-row>
              <el-dialog
                title="添加评论"
                ...
                >
                <div>
                  <el-form label-position="left" label-width="80px" :model="rate">
                    ...
                    <el-form-item label="评论内容">
                      <el-input  type="textarea"
                                 :rows="2"
                                 placeholder="请输入内容" v-model="rate.content"></el-input>
                    </el-form-item>
                  </el-form>
                </div>
      ...
      <el-card class="box-card" style="margin-top: 10px">
        ...
        <el-row >
          ...
          <el-col :span="20" align="right">
            <div style="padding-top: 15px"><el-rate
              v-model="com.rate"
              disabled
              show-text>
            </el-rate></div>
      ...
      <el-card class="box-card card" style="margin-top: 10px">
        ...
        <el-row>
          <el-col :span="4"  v-for="(r, index) in pops" :key="index" :offset="index%5!=0 ? 1 : 0" v-if="index<5">
